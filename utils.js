...
exports.createEmbed = function(triple, message){
    const embed = new Discord.MessageEmbed()
            ...
            .setTitle("Todo List 🗒")
            .setTimestamp()
            .addField("📆 " + message.author.username + "\'s tasks📌",tasksToString(triple.tasks, triple.tasksDone))
...
exports.isValidTransfer = function(balance, amount) {
  ...
  if(((balance - amount) >=0) && amount > 0 && isFinite(amount) && !isNaN(amount)) {// We transfer a positive amount.
    return true;
  } 
  return false;
}
